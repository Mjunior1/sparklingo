...
export const defaultMissionRuntimeScenes: MissionRuntimeSceneRecord[] = [
  {
    ...
    sceneTotal: 3,
    title: 'Immigration',
    subtitle: 'You just landed in London. The line is moving fast and the officer is already waiting for your answer.',
    character: 'IMMIGRATION OFFICER',
    ...
    emotionalFeedbackBody: 'A cena continua. Ajuste a resposta e você passa por esse checkpoint.',
    ...
    answers: [
      {
        ...
        feedbackBody: 'A ideia funciona, mas essa não é a forma mais natural de responder ao officer.',
        xpReward: 15,
      },
      {
        id: 'airport-a2',
        ...
        feedbackBody: 'A frase está correta, mas muda completamente o motivo da sua viagem.',
        xpReward: 18,
      },
      {
        id: 'airport-a3',
        ...
        feedbackBody: 'Clear, calm and exactly what the officer needed to hear at that moment.',
        xpReward: 25,
      },
    ],
  },
